...
function AgentChip({ name = "", icon, human = false, board = false, size = "md", style }) {
  ...
  return /* @__PURE__ */ React.createElement("span", { title: human ? "you" : name, style: { display: "inline-flex", alignItems: "center", gap: 6, ...style } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", style: {
    ...
    fontWeight: 500,
    flexShrink: 0
  } }, board ? /* @__PURE__ */ React.createElement("svg", { viewBox: BOARD_MARK_VIEWBOX, width: px * 0.58, height: px * 0.58, style: { fill: "currentColor", color: "var(--tide-4)" } }, /* @__PURE__ */ React.createElement("path", { d: BOARD_MARK_PATH })) : glyph || initials), size !== "sm" && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: "var(--text-xs)", color: "var(--text-secondary)" } }, human ? "you" : name));
}
