...
- **The index is generated.** `docs/adr/README.md` is built from `docs/adr/NNNN-*.md` by `node scripts/build-adr-index.mjs` — don't hand-edit it. After creating or superseding an ADR, run that script (a test catches staleness).
