...
- [0097](0097-provider-is-a-required-registry-declaration-and-cli-auth-is-a-per-provider-resource.md) — Provider は harness と独立した registry 必須の宣言 —— 動力の認証は provider 単位の資源に細分化する
