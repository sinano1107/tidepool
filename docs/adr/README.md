...
- [0053](0053-task-branch-forks-from-its-lineage-and-work-returns-where-it-was-cut.md) — タスクブランチの fork 元は系譜が決め、成果は切られた場所へ帰る **(決定3 の ff-only 着地と決定4 の事後検知の一点は ADR 0103 で置き換え済み)**
...
- [0092](0092-landing-waits-for-attached-children-and-the-merge-decision-follows-the-log.md) — 着地は付帯子の決着を待ち、merge 判断はログ流し読みの後に置く
