...
**Status 追記: 決定4 の `--strict-config` は [ADR 0142](0142-the-codex-preflight-parses-the-spawn-config-strictly-through-the-app-server.md) で preflight にも効く(2026-09-21)。**
